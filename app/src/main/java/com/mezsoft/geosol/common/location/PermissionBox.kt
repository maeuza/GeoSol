...
fun PermissionBox(
    ...
    val permissionState = rememberMultiplePermissionsState(permissions = permissions) { map ->
        ...
        errorText = if (rejectedPermissions.none { it in requiredPermissions }) {
            ...
            "${rejectedPermissions.joinToString()} requerido para la aplicación"
        }
    }
...
private fun PermissionScreen(
    ...
    Column(
        ...
        println("state.shouldShowRationale print ${state.shouldShowRationale}")
        Button(
            onClick = {
    ...
    println("show rationale$showRationale")
    if (showRationale) {
        AlertDialog(
            onDismissRequest = {
                showRationale = false
            ...
            title = {
                Text(text = "Permisos  requeridos por la aplicación")
            },
            text = {
                Text(text = "Se requieren los siguientes permisos de ubicación:\n $permissions")
            },
            confirmButton = {
                TextButton(
                    onClick = {
